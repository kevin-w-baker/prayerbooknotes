...
## Style 
The visual style of this blog should be simple and similar to that of a print book. The primary typeface used should be Garamond, and the overall look should be similar to that of the Episcopal Church's 1979 Book of Common Prayer.

Hugo defines styles using "Themes". I would like for you to select an existing theme and customize it, creating a new theme called "Prayerbook '79"